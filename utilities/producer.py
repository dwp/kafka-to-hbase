...
def main():
    ...
    parser.add_argument("--max-length", "-l", type=int,
                        default=1024, help="the maximum length of a message")
    ...
    while not done:
        for topic in args.topic:
            ...
            if current_length < args.max_length:
                m["data"] = garbage(random.randint(
                    1, args.max_length - current_length))
