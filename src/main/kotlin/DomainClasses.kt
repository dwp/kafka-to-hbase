...
data class HbasePayload(val key: ByteArray, val body: ByteArray, val id: String, val version: Long, val versionCreatedFrom: String, val record: ConsumerRecord<ByteArray, ByteArray>) {
